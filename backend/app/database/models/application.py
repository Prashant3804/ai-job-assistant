...
class ApplicationPolicy(Base, TimestampMixin):
    ...
    daily_application_limit: Mapped[int] = mapped_column(Integer, default=30, nullable=False)
    per_source_daily_limit: Mapped[int] = mapped_column(Integer, default=10, nullable=False)
