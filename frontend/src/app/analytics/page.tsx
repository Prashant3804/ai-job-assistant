      ...
      <div className="p-8 space-y-8 max-w-7xl w-full mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
            ...
            <div className="text-3xl font-extrabold text-amber-600 mt-2">25.0%</div>
            <p className="text-xs text-slate-400 mt-1">1 interview from 4 tracked applications</p>
          </div>

          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
            <div className="text-xs font-semibold text-slate-500 uppercase">Offer Conversion Rate</div>
            <div className="text-3xl font-extrabold text-emerald-600 mt-2">25.0%</div>
            <p className="text-xs text-slate-400 mt-1">1 offer received (Anthropic)</p>
          </div>

          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
            <div className="text-xs font-semibold text-slate-500 uppercase">Average High-Fit Match</div>
            <div className="text-3xl font-extrabold text-sky-600 mt-2">88.4%</div>
            <p className="text-xs text-slate-400 mt-1">Across top 5 recommended opportunities</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="space-y-3">
              {Object.entries(data?.funnel || { Draft: 1, Submitted: 0, 'Under Review': 1, Interview: 1, Offer: 1 }).map(
                ([stage, count]) => (
